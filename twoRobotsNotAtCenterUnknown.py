...
def main():
    ...
    distance_from_perimeter = distance(((robot1[0]-center[0])/radius, math.cos(math.asin((robot1[0]-center[0])/radius))) * radius, ((robot1[0]-center[0])/radius, (center[1]-robot1[1])/radius))

    angle_robots_meet_perimeter = math.asin((robot1[0]-center[0])/radius) % (math.pi * 2)


    angle_of_robot1 = angle_of_robot2 = math.asin((robot1[0]-width/2)/radius)
